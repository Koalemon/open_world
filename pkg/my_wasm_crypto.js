/* @ts-self-types="./my_wasm_crypto.d.ts" */

/**
 * @param {string} master_key
 * @returns {string}
 */
export function generate_password(master_key) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(master_key, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.generate_password(retptr, ptr0, len0);
 ...
 * @returns {boolean}
 */
export function verify_password(master_key, password_hex) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(master_key, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(password_hex, wasm.__wbindgen_export, wasm.__wbindgen_export2);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_disabled_5a08c4172fa44580: function(arg0) {
        ...
        __wbg_innerText_4e552186275f958d: function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('my_wasm_crypto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
